package xyz.blackdev.Blueberry.skija.core.util.font;

import io.github.humbleui.skija.Data;
import io.github.humbleui.skija.Font;
import io.github.humbleui.skija.Typeface;
import xyz.blackdev.Blueberry.skija.core.util.ResourceUtil;
...
public class FontManager {
    ...
    private static Typeface loadTypeface(String font, FontType type) {
        Optional<Data> fontDataOptional = ResourceUtil.convertToData("/assets/skija/fonts/ui/" + font);
