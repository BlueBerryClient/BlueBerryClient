package xyz.blackdev.Blueberry.skija.core.state;
...
public class State {
    ...
    public void backupCurrentState() {
        ...
        for (PixelStoreParameter parameter : PixelStoreParameter.values()) {
            pixelStores.put(parameter, GL11.glGetInteger(parameter.value));
        }
    ...
    public void restorePreviousState() {
        ...
        for (PixelStoreParameter parameter : PixelStoreParameter.values()) {
            GL11.glPixelStorei(parameter.value, pixelStores.get(parameter));
        }
    }
}
