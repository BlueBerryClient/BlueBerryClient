package xyz.blackdev.Blueberry.skija.core;
...
import xyz.blackdev.Blueberry.skija.core.state.UIState;
...
public class SkiaRenderer {
     ...
     */
    static Window Display = MinecraftClient.getInstance().getWindow();
